...
class MediaFolderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return back()->with('success', $this->flashMessage('notifications.folder.created'));
    }
    ...
    public function destroy(MediaFolder $medium)
    {
        ...
        return redirect('/files')->with('success', $this->flashMessage('notifications.folder.deleted'));
    }
}
