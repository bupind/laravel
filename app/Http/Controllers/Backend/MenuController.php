...
class MenuController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('menus.index')->with('success', $this->flashMessage('notifications.menu.created'));
    }
    ...
    public function update(Request $request, Menu $menu)
    {
        ...
        return redirect()->route('menus.index')->with('success', $this->flashMessage('notifications.menu.updated'));
    }
    ...
    public function destroy(Menu $menu)
    {
        ...
        return redirect()->route('menus.index')->with('success', $this->flashMessage('notifications.menu.deleted'));
    }
    ...
    public function reorder(Request $request)
    {
        ...
        return redirect()->back()->with('success', $this->flashMessage('notifications.menu.order_saved'));
    }
}
