                ...
                <div className="space-y-6">
                    ...
                    <form onSubmit={updatePassword} className="space-y-6">
                        <div className="grid gap-2">
                            <Label htmlFor="current_password">{t('labels.currentPassword')}</Label>
                        ...
                        <div className="flex items-center gap-4">
                            <Button disabled={processing}>{t('buttons.save')}</Button>
                            ...
                            <Transition
                                ...
                                leaveTo="opacity-0"
                            >
                                <p className="text-sm text-gray-600">{t('buttons.saved')}</p>
                            </Transition>
                        </div>
                    </form>
                </div>
